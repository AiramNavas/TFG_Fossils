...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            Vector3 desiredMove;
            if (!underWater) desiredMove = transform.GetChild(0).forward * m_Input.y + transform.GetChild(0).right * m_Input.x;
            else desiredMove = transform.GetChild(1).forward * m_Input.y + transform.GetChild(1).right * m_Input.x;
